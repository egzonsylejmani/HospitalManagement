...
<template>
    ...
    <div class="flex justify-between mb-4">
        <h1 class="text-2xl font-bold mb-4">Doctors</h1>
                <button  class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-1/5" @click="showAddModal = true">Add Doctor</button>
    </div>
...
export default {
    ...
    methods: {
       addUser() {
        ...
        getUsers() {
            axios
                .get("http://localhost:3501/api/doctors/")
                .then((response) => {
