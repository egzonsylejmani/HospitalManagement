...
export default {
    ...
    methods: {
        addUser() {
            axios.post('http://localhost:3501/api/laborants', this.newUser)
            .then(response => {
        ...
        saveUser() {
        axios.put(`http://localhost:3501/api/laborants/${this.editingUser._id}`, this.editingUser)
            .then(() => {
        ...
        if (
            ...
            axios
            .delete(`http://localhost:3501/api/laborants/${user._id}`)
            .then(() => {
        ...
        getUsers() {
            axios
                .get("http://localhost:3501/api/laborants/")
                .then((response) => {
