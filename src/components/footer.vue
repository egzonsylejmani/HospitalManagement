<template>
 <footer className="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24" style="margin-top:19%">
      <div className="flex flex-col md:flex-row">
        <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
          <h3 className="font-bold text-2xl">Migna</h3>
          <p className="text-gray-400">A better life starts with our Hospital</p>

          <form className="flex items-center mt-6">
            <div className="w-full">
              <label className="py-3 block uppercase tracking-wide text-gray-600 text-xs font-bold " for="grid-last-name">
          ...
          <ul className="mt-4">
            <li>
              <a href="#" title="" className="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span className="ml-3">1985 Muharrem Fejza, Pristina, Kosovo</span>
              </a>
            </li>
            <li className="mt-4">
              <a href="#" title="" className="block flex items-center opacity-75 hover:opacity-100">
            ...
            <li className="mt-4">
              <a href="#" title="" className="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span className="ml-3">+383 49 123 321</span>
              </a>
            </li>
            <li className="mt-4">
              <a href="#" title="" className="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span className="ml-3">Migna.Hospital@gmail.com</span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div className=" w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
          ...
          <p className="  text-sm text-gray-400 mt-28">
            © 2022 Migna Hospital <br className="hidden lg:block" />
            All Rights Reserved.
          </p>
