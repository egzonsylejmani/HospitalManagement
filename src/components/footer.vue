  ...
  <footer class="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
    <div class="flex flex-col md:flex-row">
      <div class="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
        <h3 class="font-bold text-2xl">Migna</h3>
        <p class="text-gray-400">A better life starts with our Hospital</p>
        <form class="flex items-center mt-6">
          <div class="w-full">
            <label class="py-3 block uppercase tracking-wide text-gray-600 text-xs font-bold" for="grid-last-name">
            ...
            <div class="relative">
              ...
              <button type="submit" class="bg-teal-500 hover:bg-teal-400 text-white px-4 py-2 text-sm font-bold rounded absolute top-0 right-0 my-2 mr-2">
                Subscribe
              </button>
            </div>
          </div>
    ...
    </div>  <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
    ...
    </div><div class="w-full lg:w-2/6 mt-8 lg:mt-0 lg:mx-4 lg:pr-8">
      ...
      <ul class="mt-4">
        <li>
          <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
            ...
            <span class="ml-3">1985 Muharrem Fejza, Pristina, Kosovo</span>
          </a>
        </li>
        <li class="mt-4">
          <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
            ...
            <span class="ml-3">Your Email</span>
          </a>
        </li>
      </ul>
    </div>
            ...
            <span className="ml-3">
              ...
              <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span class="ml-3">+383 49 123 321</span>
              </a>
            </li>
            <li class="mt-4">
              <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                ...
                <span class="ml-3">Migna.Hospital@gmail.com</span>
              </a>
            </li>
...
<path d="M21.593,7.203c-0.23-0.858-0.905-1.535-1.762-1.766C18.265,5.007,12,5,12,5S5.736,4.993,4.169,5.404	c-0.84,0.229-1.534,0.921-1.766,1.778c-0.413,1.566-0.417,4.814-0.417,4.814s-0.004,3.264,0.406,4.814	c0.23,0.857,0.905,1.534,1.763,1.765c1.582,0.43,7.83,0.437,7.83,0.437s6.265,0.007,7.831-0.403c0.856-0.23,1.534-0.906,1.767-1.763	C21.997,15.281,22,12.034,22,12.034S22.02,8.769,21.593,7.203z M9.996,15.005l0.005-6l5.207,3.005L9.996,15.005z" />
      ...
      <p class="text-sm text-gray-400 mt-28">
        © 2022 Migna Hospital <br class="hidden lg:block" />
        All Rights Reserved.
      </p>
    </div>
  </footer>
