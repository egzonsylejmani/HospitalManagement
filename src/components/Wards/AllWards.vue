<template>
    ...
    <button  class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-1/5" @click="showAddModal = true">Add Ward</button>
...
export default {
  ...
  methods: {
    ...
    getUsers() {
      axios
        .get("http://localhost:3501/api/wards/")
        .then((response) => {
